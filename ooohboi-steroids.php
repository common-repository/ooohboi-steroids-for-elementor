...
final class OoohBoi_Steroids {
	...
	*/
	public function ooohboi_register_styles_editor() {
		...
		wp_enqueue_style( 'ooohboi-steroids-styles-editor', plugins_url( 'assets/css/editor.css', __FILE__ ), NULL, self::VERSION );
	...
	*/
	public function ooohboi_register_scripts_front() {
		...
		wp_register_script( 'ooohboi-steroids', plugins_url( 'assets/js/ooohboi-steroids.js', __FILE__ ), [ 'jquery' ], false, true );
